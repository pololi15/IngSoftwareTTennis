...
describe("TennisScorer", () => {
  ...
  it("El Jugador 1 marca 3 puntos y el jugador 2 marca 3 puntos", () => {
    const scorer = new TennisScorer(0,0);
    scorer.player1Scores();
    scorer.player1Scores();
    scorer.player1Scores();
  ...
  it("El Jugador 1 marca 4 puntos y el jugador 2 marca 3 puntos", () => {
    const scorer = new TennisScorer(0,0);
    scorer.player1Scores();
    scorer.player1Scores();
    scorer.player1Scores();
  ...
  it("El Jugador 1 marca 5 puntos y el jugador 2 marca 3 puntos", () => {
    const scorer = new TennisScorer(0,0);
    scorer.player1Scores();
    scorer.player1Scores();
    scorer.player1Scores();
  ...
  it("El Jugador 2 marca 5 puntos y el jugador 1 marca 3 puntos", () => {
    const scorer = new TennisScorer(0,0);
    scorer.player2Scores();
    scorer.player2Scores();
    scorer.player2Scores();
